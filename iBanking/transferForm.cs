...
namespace iBanking
{
    public partial class transferForm : Form
    {
        ...
        {
            if (textBoxFromAccountNo.Text == string.Empty && textBoxFromAcName.Text == string.Empty)
            {
                MessageBox.Show("Please Enter Form Account No");
            }
            else if(textBoxToAccount.Text == string.Empty)
            {
                MessageBox.Show("Please Enter To Account No");
            }
            ...
            else
            {
                ...
                if (b1 > totalBlance)
                {
                    tblConsumerAccount item2 = (from u in iBS.tblConsumerAccounts
